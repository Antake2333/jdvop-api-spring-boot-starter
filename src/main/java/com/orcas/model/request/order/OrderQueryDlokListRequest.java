...
import com.orcas.model.response.order.OrderQueryDlokListResponse;
...
@AllArgsConstructor
@NoArgsConstructor
public class OrderQueryDlokListRequest extends BaseRequest<OrderQueryDlokListResponse> {
  ...
  @Data
  public static class JdOrderQueryDlokListRequest implements Serializable {
  ...
  @Override
  public TypeReference<OrderQueryDlokListResponse> getRespTypeReference() {
    return new TypeReference<OrderQueryDlokListResponse>() {};
  }

  @Override
  public Object into() {
    JdOrderQueryDlokListRequest request = new JdOrderQueryDlokListRequest();
