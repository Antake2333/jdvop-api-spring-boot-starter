...
@AllArgsConstructor
@NoArgsConstructor
public class OrderQueryRefuseListRequest extends BaseRequest<OrderQueryRefuseListResponse> {
  ...
  @Data
  public static class JdOrderQueryRefuseListRequest implements Serializable {
  ...
  @Override
  public Object into() {
    JdOrderQueryRefuseListRequest request = new JdOrderQueryRefuseListRequest();
