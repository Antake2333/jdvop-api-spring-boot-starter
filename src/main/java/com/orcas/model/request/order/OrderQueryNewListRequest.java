...
import com.orcas.model.response.order.OrderQueryNewListResponse;
...
@AllArgsConstructor
@NoArgsConstructor
public class OrderQueryNewListRequest extends BaseRequest<OrderQueryNewListResponse> {
  ...
  @Data
  public static class JdOrderQueryNewListRequest implements Serializable {
  ...
  @Override
  public TypeReference<OrderQueryNewListResponse> getRespTypeReference() {
    return new TypeReference<OrderQueryNewListResponse>() {};
  }

  @Override
  public Object into() {
    JdOrderQueryNewListRequest request = new JdOrderQueryNewListRequest();
